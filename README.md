...
Deploy immudb 1.11.2 with a generated admin password and daily-backed-up immutable storage. The verified deploy button is added after publication.
...
Upstream: https://github.com/codenotary/immudb/tree/v1.11.2 (Apache-2.0). immudb is not affiliated with Railway.
